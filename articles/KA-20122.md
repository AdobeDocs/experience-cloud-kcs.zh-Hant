...
- Sites編輯器中的PathField可讓作者從「內容尋找器」拖曳資產。
...
自訂範例將droppable=true的PathField新增至WKND教學課程的HelloWorld元件，如/apps/wknd/components/helloworld/cq:dialog/content/items/column/items/path: 
