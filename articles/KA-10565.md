---
title: 無法連線至Brand Portal，出現「JWT已過期」錯誤 | AEM
description: 說明
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager
keywords: KCS, connect, Brand Portal，復寫代理， JWT已過期， AEM, Adobe Experience Manager, 6.2，錯誤
...
# 無法連線至Brand Portal，出現「JWT已過期」錯誤 | AEM

## 說明


<b>問題 </b>
設定AEM Assets與Brand Portal的整合後 [https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html?lang=en](https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html?lang=zh-Hant),

<b>測試連線</b> 在復寫代理上，會傳回類似下列的錯誤訊息：
...
<b>環境</b>
AEM 6.2與Brand Portal

<b>原因</b>
原因是AEM例項和Brand Portal雲端之間的時間差。
差異會導致JWT過期。
