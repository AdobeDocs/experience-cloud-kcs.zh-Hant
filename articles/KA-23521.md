---
title: 移動頁面功能無法運作
description: 瞭解如何解決移動頁面功能因擷取內容片段參考發生問題而造成刪除或發佈失敗的問題。
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager 6.5
keywords: KCS、移動頁面功能、刪除、參考擷取問題、AMS客戶、CSE協助、重新索引、內容片段、發佈
...
探索如何解決由於內容片段參考擷取問題而阻礙刪除或發佈等動作的移動頁面功能故障。
...
嘗試移動、刪除或發佈內容片段、網站或頁面時，擷取內容片段參考時會發生問題，導致動作受阻。
