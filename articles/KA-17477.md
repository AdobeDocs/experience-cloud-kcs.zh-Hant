...
[&lt; — 上一個：基本檔案配置](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17502.html?lang=zh-Hant)
...
以下是AMS基線目錄，最上層包含
![AMS基線包含以dispatcher_vhost.conf開頭的，其中將包含/etc/httpd/conf.d/enabled_vhosts/目錄中任何包含*.vhost的檔案。  /etc/httpd/conf.d/enabled_vhosts/目錄中的項目是指向/etc/httpd/conf.d/available_vhosts/中實際配置檔案的符號連結](assets/Apache-Webserver-AMS-Baseline-Includes.png "Apache-Webserver-AMS-Baseline-Includes")
...
如您所見，這包括頂層 `dispatcher.any` dispatcher模組的檔案，以從 `/etc/httpd/conf.dispatcher.d/dispatcher.any`
...
![本圖顯示一個.vhost檔案如何包含變數、白名單和重寫資料夾的檔案](assets/Apache-Webserver-AMS-Vhost-Includes.png "Apache-Webserver-AMS-Vhost-Includes")
...
![<FILENAME>_farms.any將包含子.any檔案以完成場配置。  在此圖中，您可以看到伺服器陣列將包含每個頂層區段檔案快取、剪貼簿、篩選器、轉譯，以及.any檔案](assets/Apache-Webserver-AMS-Farm-Includes.png "Apache-Webserver-AMS-Farm-Includes")
...
[下一步 — >了解快取](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17912.html?lang=zh-Hant)