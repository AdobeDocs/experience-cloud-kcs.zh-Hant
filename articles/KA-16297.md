...
# AEM範本從 [!DNL Campaign] 主控台

## 說明


問題說明=將AEM範本同步至 [!DNL Campaign]，我們會收到下列錯誤：
...
復寫權限必須授予AEM伺服器中Campaign的AEM使用者。  我們授予 [!DNL Campaign]的AEM使用者，位於/content/campaign和/content/dam路徑下，其中存在促銷活動資產。
