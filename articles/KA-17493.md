...
[&lt; — 上一個：使用和了解變數](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17487.html?lang=zh-Hant)
...
![作者會啟用內容，而觸發發佈者傳送要排清至dispatcher的請求](assets/dispatcher-flushing-order-of-events.png "dispatcher-flushing-order-of-events")
...
![AEM網頁上標準復寫代理的螢幕擷圖/etc/replication.html](assets/author-rep-agent-example.png "author-rep-agent-example")
...
![AEM網頁中標準刷新複製代理的螢幕截圖/etc/replication.html](assets/publish-flush-rep-agent-example.png "publish-flush-rep-agent-example")
...
以下是顯示這些值之設定頁面的螢幕擷圖：
![主配置螢幕設定頁簽的圖片，序列化類型顯示為Dispatcher刷新](assets/disp-flush-agent1.png "disp-flush-agent1")

預設設定頁面會顯示 `Serialization Type` as `Dispatcher Flush` 並設定錯誤等級

![複製代理的傳輸頁簽螢幕截圖。  這會顯示將排清請求過帳到的URI。  /dispatcher/invalidate.cache](assets/disp-flush-agent2.png "disp-flush-agent2")
...
![複製代理的「擴展」頁簽的螢幕截圖。  記下隨傳送的POST請求傳送的標題，以告知Dispatcher排清](assets/disp-flush-agent3.png "disp-flush-agent3")
...
![標準復寫代理的畫面，顯示從製作發佈內容的復寫事件收到新項目時，具有react和trigger的復寫代理](assets/disp-flush-agent4.png "disp-flush-agent4")
...
![混合了內容和日期的statfiles，顯示了stat級別](assets/dispatcher-statfiles.png "dispatcher-statfiles")
...
[下一個 — >虛名URL](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17463.html?lang=zh-Hant)