---
title: "Campaign Classic:重新啟動時WEB進程報告缺少的JAR檔案"
description: 說明
solution: Campaign
product: Campaign
applies-to: "Campaign Classic"
keywords: "KCS, ACC, Adobe Campaign Classic, JAR檔案找不到， OO_INSTALL_DIR, WEB進程，重新啟動，錯誤，類路徑標籤，升級， serverConf.xml配置檔案"
...
# Campaign Classic:重新啟動時WEB進程報告缺少的JAR檔案
...
此 `classpath` 標籤 `serverConf.xml` 升級後未正確更新設定檔。

此 `classpath` 標籤應指向最新的JAR。
