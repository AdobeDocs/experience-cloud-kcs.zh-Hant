...
description: 瞭解如何解決在AEM中開啟頁面時的\「錯誤請求\」錯誤。
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: 「KCS、大小、請求標頭、超過、伺服器限制、AEM、Adobe Experience Manager、疑難排解、AEMaaCS、Adobe Experience Manager as a Cloud Service」
...
Apache has a default `LimitRequestLine` of *8K*. 如需詳細資訊，請參閱 [Apache的核心功能： LimitRequestLine指令](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) （位於Apache網站）。

提高的值可克服此錯誤 `#LimitRequestFieldSize` 和 `#LimitRequestLine`.

<u>用於AMS/內部部署</u>：

可在Apache設定檔案中提高標頭限制 —  `httpd.conf`.
