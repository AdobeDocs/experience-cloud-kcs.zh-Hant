...
<br><br><br> <br><br>
當AMS調配系統時，會推出基線配置，使所有功能都可正常運作且安全。  AMS不想將這些作為功能與安全性的基準。  要完成此操作，某些檔案被標籤為只讀和不可變，以避免您更改它們。
...
現在，Apache webserver知道網域是某些內容應會產生的流量，但我們仍需通知Dispatcher模組，它有新的網域名稱需遵守。  首先，我們將建立一個新的\*_vhost.any檔案/etc/httpd/conf.dispatcher.d/vhosts/weretail_vhosts.any ，然後在該檔案中，我們將放入要遵守的域名：
