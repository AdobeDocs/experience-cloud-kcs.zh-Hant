...
[&lt; — 上一個：常見記錄檔](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17914.html?lang=zh-Hant)
...
![展示一個保齡球道，球滾著。  球上有一個箭頭，上面寫著。  水溝阻擋器被抬起，上面有不可修改的字。](assets/bowling-file-immutability.png "bowling-file-micutibility")
...
現在，Apache webserver知道網域是它應該產生流量的網域，但我們仍需通知Dispatcher模組，它有新的網域名稱要遵守。  首先，我們將建立 `*_vhost.any` 檔案 `/etc/httpd/conf.dispatcher.d/vhosts/weretail_vhosts.any` 在檔案里，我們要放入我們要遵守的域名：
