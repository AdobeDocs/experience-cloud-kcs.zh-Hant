...
<b>問題/症狀</b>
<br>在2023.02.11382版中，GraphQL（開放原始碼查詢語言）實作已進行一些改善，可能會在應用程式程式碼中造成非預期行為，以防其依賴較舊版本的錯誤行為。 
<br>下列提及的解決方法有助於達成以下目標： Adobe Experience Manager(AEM)GraphQL現在可在所有篩選操作中以一致的null值傳回內容。 <br><br>
