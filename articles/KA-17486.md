...
- 使用及最佳化AEM使用者端程式庫 — 使用者端程式庫是集中管理及最佳化網站中CSS和JavaScript程式碼的簡單方法。
   ...
   - [內嵌](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) 使用者端程式庫，可將其整合為較少的檔案。
   - [最小化](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) 程式庫。
