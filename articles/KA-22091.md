---
title: '"管道失敗，出現錯誤\"end_aem_createsegmentstore屬性缺失\"'
description: 說明
...
# 管道失敗，錯誤為「缺少end_aem_createsegmentstore屬性」

## 說明 {#description}

在「部署到開發」階段，CI/CD管道一直失敗。 <br><br>由於代碼庫，部署日誌未顯示任何錯誤，但存在以下錯誤：<br><br> <br><br> <br><br> <br><br>`[` 1`]`  
...
檢查管道時，可以看到管道失敗，出現錯誤「errorCode」：&quot;BLOCKED_QUEUE&quot;。

這意味著複製隊列被阻止，妨礙了其他可變內容的安裝。

日誌中的錯誤 `[` 1`]`  在部署時間段記憶體在。 很可能是節點。 `[` 2`]`  發佈伺服器和/或預覽伺服器上不存在，複製失敗。
